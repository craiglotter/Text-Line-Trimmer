...
Public Class Main_Screen
    ...
    Private Sub Main_Screen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text = My.Application.Info.ProductName & " " & System.String.Format("{0}{1:00}{2:00}.{3:00}", My.Application.Info.Version.Major, My.Application.Info.Version.Minor, My.Application.Info.Version.Build, My.Application.Info.Version.Revision) & ""
                    ...
                    If whichbuttonpressed = 1 Then
                        If lineread.Length >= NumericUpDown1.Value Then
                            If RadioButton1.Checked = True Then
                                lineread = lineread.Remove(0, NumericUpDown1.Value)
    ...
    Private Sub InputTargetFile_Textbox_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles InputTargetFile_Textbox.TextChanged
        Try
            ...
            End If
        Catch ex As Exception
            Error_Handler(ex, "Enable LinkLabel2")
        End Try
    End Sub
    ...
    Private Sub LinkLabel2_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkLabel2.LinkClicked
        Try
            If File_Exists(InputTargetFile_Textbox.Text) = True Then
                ...
                If finfo.Exists = True Then
                    Dim apptorun As String
                    apptorun = """" & (systemDirectory & "\notepad.exe").Replace("\\", "\") & """ """ & InputTargetFile_Textbox.Text & """"
                    Dim procID As Integer = Shell(apptorun, AppWinStyle.NormalFocus, False)
                End If
                finfo = Nothing
            End If
